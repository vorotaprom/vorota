...
@Component({
  selector: 'app-modal-from-order-swing3000pro',
  templateUrl: './modal-from-order-swing3000pro.component.html',
  styleUrls: ['./modal-from-order-swing3000pro.component.scss']
})
export class ModalFromOrderSwing3000proComponent implements OnInit {
