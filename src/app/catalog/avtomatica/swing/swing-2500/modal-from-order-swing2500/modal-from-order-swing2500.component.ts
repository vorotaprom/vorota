...
@Component({
  selector: 'app-modal-from-order-swing2500',
  templateUrl: './modal-from-order-swing2500.component.html',
  styleUrls: ['./modal-from-order-swing2500.component.scss']
})
export class ModalFromOrderSwing2500Component implements OnInit {
