...
@Component({
  selector: 'app-modal-from-order-arm320pro',
  templateUrl: './modal-from-order-arm320pro.component.html',
  styleUrls: ['./modal-from-order-arm320pro.component.scss']
})
export class ModalFromOrderArm320proComponent implements OnInit {
