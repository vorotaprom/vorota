...
@Component({
  selector: 'app-modal-from-order-swing5000pro',
  templateUrl: './modal-from-order-swing5000pro.component.html',
  styleUrls: ['./modal-from-order-swing5000pro.component.scss']
})
export class ModalFromOrderSwing5000proComponent implements OnInit {
