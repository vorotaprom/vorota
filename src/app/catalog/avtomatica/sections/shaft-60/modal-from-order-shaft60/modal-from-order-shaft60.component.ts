...
@Component({
  selector: 'app-modal-from-order-shaft60',
  templateUrl: './modal-from-order-shaft60.component.html',
  styleUrls: ['./modal-from-order-shaft60.component.scss']
})
export class ModalFromOrderShaft60Component implements OnInit {
