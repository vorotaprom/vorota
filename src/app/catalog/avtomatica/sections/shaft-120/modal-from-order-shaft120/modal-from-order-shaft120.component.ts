...
@Component({
  selector: 'app-modal-from-order-shaft120',
  templateUrl: './modal-from-order-shaft120.component.html',
  styleUrls: ['./modal-from-order-shaft120.component.scss']
})
export class ModalFromOrderShaft120Component implements OnInit {
