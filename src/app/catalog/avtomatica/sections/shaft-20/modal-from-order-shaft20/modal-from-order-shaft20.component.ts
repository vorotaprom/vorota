...
@Component({
  selector: 'app-modal-from-order-shaft20',
  templateUrl: './modal-from-order-shaft20.component.html',
  styleUrls: ['./modal-from-order-shaft20.component.scss']
})
export class ModalFromOrderShaft20Component implements OnInit {
