...
@Component({
  selector: 'app-modal-from-order-shaft50pro',
  templateUrl: './modal-from-order-shaft50pro.component.html',
  styleUrls: ['./modal-from-order-shaft50pro.component.scss']
})
export class ModalFromOrderShaft50proComponent implements OnInit {
