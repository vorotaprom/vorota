...
@Component({
  selector: 'app-modal-from-order-se1200',
  templateUrl: './modal-from-order-se1200.component.html',
  styleUrls: ['./modal-from-order-se1200.component.scss']
})
export class ModalFromOrderSe1200Component implements OnInit {
