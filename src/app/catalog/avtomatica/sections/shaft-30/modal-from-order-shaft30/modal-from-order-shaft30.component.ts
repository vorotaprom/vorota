...
@Component({
  selector: 'app-modal-from-order-shaft30',
  templateUrl: './modal-from-order-shaft30.component.html',
  styleUrls: ['./modal-from-order-shaft30.component.scss']
})
export class ModalFromOrderShaft30Component implements OnInit {
