...
@Component({
  selector: 'app-modal-from-order-se1000pro',
  templateUrl: './modal-from-order-se1000pro.component.html',
  styleUrls: ['./modal-from-order-se1000pro.component.scss']
})
export class ModalFromOrderSe1000proComponent implements OnInit {
