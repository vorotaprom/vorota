...
@Component({
  selector: 'app-modal-from-order-shaft50',
  templateUrl: './modal-from-order-shaft50.component.html',
  styleUrls: ['./modal-from-order-shaft50.component.scss']
})
export class ModalFromOrderShaft50Component implements OnInit {
