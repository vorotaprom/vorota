...
@Component({
  selector: 'app-modal-from-order-sliding1300pro',
  templateUrl: './modal-from-order-sliding1300pro.component.html',
  styleUrls: ['./modal-from-order-sliding1300pro.component.scss']
})
export class ModalFromOrderSliding1300proComponent implements OnInit {
