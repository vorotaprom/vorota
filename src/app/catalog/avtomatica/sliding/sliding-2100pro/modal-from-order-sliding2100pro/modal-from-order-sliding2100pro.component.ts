...
@Component({
  selector: 'app-modal-from-order-sliding2100pro',
  templateUrl: './modal-from-order-sliding2100pro.component.html',
  styleUrls: ['./modal-from-order-sliding2100pro.component.scss']
})
export class ModalFromOrderSliding2100proComponent implements OnInit {
