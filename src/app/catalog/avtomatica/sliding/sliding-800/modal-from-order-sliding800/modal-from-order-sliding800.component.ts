...
@Component({
  selector: 'app-modal-from-order-sliding800',
  templateUrl: './modal-from-order-sliding800.component.html',
  styleUrls: ['./modal-from-order-sliding800.component.scss']
})
export class ModalFromOrderSliding800Component implements OnInit {
